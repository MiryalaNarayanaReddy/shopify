...
function CartItem({ cartItem, setCart, cart }) {
    ...
    return (
        ...
        <tr>
            ...
            <td className=" p-2 text-red-500 font-bold"> Rs {cartItem.price_per_unit}</td>
            <td className=" p-2 text-lg">{cartItem.quantity}</td>
            <td className=" p-2 text-lg"> Rs {cartItem.price_per_unit * cartItem.quantity}</td>
                ...
                <table className="table-auto ">
                    ...
                    <tbody className="text-lg">
                        ...
                        <tr>
                            ...
                            <td className=" p-2 text-lg"> Rs {totalprice}</td>
